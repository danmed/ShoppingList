  ...
  <body>
    ...
    <form method="post" id="to_do_form">
        ...
        <span id="message"></span>
            <div class="col">
                <input type="text" id="task_name" class="form-control" placeholder="Item" aria-label="Item">
            </div>
            <div class="col">
                <input type="text" id="person_name" class="form-control" placeholder="Note" aria-label="Note">
            </div>
            <div class="col">
            <button type="submit" id="add_task" class="btn btn-primary">Add Item</button>
...
<script>
 ...
 $(document).ready(function(){
  ...
  $(document).on('submit', '#to_do_form', function(event){
   ...
   if($('#task_name').val() == '')
   {
    $('#message').html('<div class="alert alert-danger">Add Item</div>');
    return false;
   }
   else
   {
